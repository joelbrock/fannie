...
if (isset($_POST['submit'])) {
	...
	echo "<html><head><title>Department Sales Movement</title>
		<script type=\"text/javascript\" src=\"../src/js/tablesort.js\"></script>
...
<div id="alert">
<p>Sales data only exists for the month of January, 2009.  Reports run on other dates will return zero results.<br />
So pick 2009-01 dates to test the reports with!</p></div>
<div id="box">
	<table border="0" cellspacing="3" cellpadding="3">
		<tr> 
            <th><p><b>Select dept.*</b></p></th><th><p><b>Or choose an item property</b></p></th> 
		</tr>
		<tr valign=top>';
