...
if ($_POST['submit']) {
	...
	foreach ($_POST['deleteItem'] as $del) {
		$result0 = mysql_query("INSERT INTO legacy_products SELECT * FROM products WHERE upc = $del");
		$result = mysql_query("DELETE FROM products WHERE upc = $del");
...
$deptResult = mysql_query("SELECT dept_no, dept_name FROM departments WHERE dept_no <= 20");
