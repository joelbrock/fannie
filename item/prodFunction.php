...
function itemParse($upc){
    ...
    if($num == 0 || !$num){
        ...
        // echo "<td><b>Price</b></td><td>$<input type=text value='$rowItem[2]' name=price size=6></td></tr>";
...
//						echo "</td><td>$likeCodeRow[2]</td><td><a href=./testSales.php?upc=$upc target=blank>Click for History</a></tr>";
				...
				echo "<td colspan='3' align='left'>Bottle deposit</td></tr>";
               	echo "<tr><td><input type='submit' name='submit' value='submit'>&nbsp;<a href='../item/itemMaint.php'><font size='-1'>cancel</font></a>";
